...
public partial class SobrancelhaPage : ContentPage
{
    private readonly ProfissionalViewModel _viewModel;
    private readonly ApiServices _apiServices;
    private ISQLiteDbServive _sQLiteDbServive;

    public SobrancelhaPage(ApiServices apiServices, ISQLiteDbServive sQLiteDbServive)
    {
        this.IsBusy = false;
    ...
    private void BtnEsquerda_Clicked(object sender, EventArgs e)
    {
        ...
        string profissionalTipo = "Design-de-sobrancelha";
        string categoria = "Moda-e-beleza";
