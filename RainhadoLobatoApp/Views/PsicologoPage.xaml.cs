...
public partial class PsicologoPage : ContentPage
{
    private readonly ProfissionalViewModel _viewModel;
    private readonly ApiServices _apiServices;
    private ISQLiteDbServive _sQLiteDbServive;

    public PsicologoPage(ApiServices apiServices, ISQLiteDbServive sQLiteDbServive)
    {
        this.IsBusy = false;
    ...
    private void BtnEsquerda_Clicked(object sender, EventArgs e)
    {
        ...
        string profissionalTipo = "Psicologo";
