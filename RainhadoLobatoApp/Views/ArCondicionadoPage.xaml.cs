...
public partial class ArCondicionadoPage : ContentPage
{
    private readonly ProfissionalViewModel _viewModel;
    private readonly ApiServices _apiServices;
    private ISQLiteDbServive _sQLiteDbServive;
    public ArCondicionadoPage(ApiServices apiServices, ISQLiteDbServive sQLiteDbServive)
    {
        this.IsBusy = false;
