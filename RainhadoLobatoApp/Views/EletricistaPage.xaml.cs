...
public partial class EletricistaPage : ContentPage
{
    private readonly ProfissionalViewModel _viewModel;
    private readonly ApiServices _apiServices;
    private ISQLiteDbServive _sQLiteDbServive;

    public EletricistaPage(ApiServices apiServices, ISQLiteDbServive sQLiteDbServive)
    {
        this.IsBusy = false;
    ...
    private void BtnEsquerda_Clicked(object sender, EventArgs e)
    {
        ...
        string profissionalTipo = "Eletricista";
        string categoria = "Reformas-e-raparos";
    ...
    {
        int page = int.Parse(Preferences.Get("Eletricista", string.Empty));
        ...
        if (Total > 0)
        {
            ...
            Preferences.Set("Eletricista", page.ToString());
            LebelCountPage.Text = Preferences.Get("PagePlus", string.Empty);
